 ...
 */
    public QueryFrame(QueryRunner queryrunnerObj) {
        ...
        jComboBoxQuery.setFont(new java.awt.Font("Chalkboard", 0, 16));
    ...
    private void initComponents() {
        ...
        jTextFieldDatabase = new javax.swing.JTextField("mm_cpsc502101team07"); // keyed our database name
        jTextFieldDatabase.setFont(new java.awt.Font("Chalkboard", 0, 12)); // changed database's font
        jScrollPane1 = new javax.swing.JScrollPane();
        jTextArea1 = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        jTextArea2 = new javax.swing.JTextArea();
        jTextHostname = new javax.swing.JTextField("cs100"); // keyed our host name
        jTextHostname.setFont(new java.awt.Font("Chalkboard", 0, 12)); // changed hostname's font
        jTextFieldUser = new javax.swing.JTextField("mm_cpsc502101team07"); // keyed our username
        jTextFieldUser.setFont(new java.awt.Font("Chalkboard", 0, 12)); // changed field user's font
        ...
        jPasswordField1.setFont(new java.awt.Font("Chalkboard", 0, 12)); // changed password field's font
        jLabel13 = new javax.swing.JLabel();
        jLabel14 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().setBackground(new java.awt.Color(220, 241, 203));
        ...
        jLabel4.setBackground(new java.awt.Color(255, 204, 218));
        ...
        jConnectButton.setFont(new java.awt.Font("Chalkboard", 0, 16));
        ...
        jBtnRunQuery.setFont(new java.awt.Font("Chalkboard", 0, 16));

        jPasswordField1.setText("mm_cpsc502101team07Pass-"); // keyed our password
        ...
        jLabel13.setFont(new java.awt.Font("Chalkboard", 0, 16));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else
        {
            ...
            if (bOK ==true)
            {
                ...
                m_jTable.setBackground(Color.white); // set color to white
                m_jTable.setFont(new java.awt.Font("Chalkboard", 0, 16)); // change the output font
                m_scrollPane = new JScrollPane(m_jTable);
                jPanel2.add(m_scrollPane);// add table in panel using add() method
                jPanel2.setFont(new java.awt.Font("Chalkboard", 0, 16)); // change the output font
